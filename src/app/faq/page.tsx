...
import { PageProps } from '../../../.next/types/app/faq/page';
...
export default function FaqPage({ params, searchParams }: PageProps) {
  // Use params and searchParams directly here if needed.
  return (
